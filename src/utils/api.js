...
// const API_BASE_URL = 'https://radnus-billingsoftware-backend.onrender.com'; // Example
...
//   repairDate: job.service?.repairDate ? new Date(job.service.repairDate) : new Date(),
...
// // ---------- API Functions (all paths now start with /api) ----------
// export const api = {
//   // Auth
...
//   deleteJob: async (id) => {
//     // If you add DELETE route in backend, use: await apiClient.delete(`/api/jobsheets/${id}`);
