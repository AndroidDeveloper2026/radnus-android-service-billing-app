...
// ─── NEW: Status Update ────────────────────────────────────────────────────
export const updateJobStatus = createAsyncThunk('jobs/updateStatus', async ({ id, status, updatedBy }) => {
  return await api.updateJobStatus(id, status, updatedBy);
});

// ─── NEW: Repair Steps ────────────────────────────────────────────────────
export const addRepairStep = createAsyncThunk('jobs/addStep', async ({ id, step, note, completedBy }) => {
  return await api.addRepairStep(id, step, note, completedBy);
});

export const toggleRepairStep = createAsyncThunk('jobs/toggleStep', async ({ id, stepId, done, completedBy }) => {
  return await api.toggleRepairStep(id, stepId, done, completedBy);
});

export const deleteRepairStep = createAsyncThunk('jobs/deleteStep', async ({ id, stepId }) => {
  return await api.deleteRepairStep(id, stepId);
});

// ─── NEW: Transfer ────────────────────────────────────────────────────────
export const transferJob = createAsyncThunk('jobs/transfer', async ({ id, from, to, note }) => {
...
// ─── NEW: Cancel ──────────────────────────────────────────────────────────
export const cancelJob = createAsyncThunk('jobs/cancel', async ({ id, cancelRemarks, cancelledBy }) => {
  return await api.cancelJob(id, cancelRemarks, cancelledBy);
});

// ─── NEW: Rebill ──────────────────────────────────────────────────────────
export const rebillJob = createAsyncThunk('jobs/rebill', async ({ id, rebilledBy }) => {
  return await api.rebillJob(id, rebilledBy);
});

// ─── NEW: Update Spares ────────────────────────────────────────────────────
export const updateSpares = createAsyncThunk('jobs/updateSpares', async ({ id, spareItems }) => {
