...
const reportSlice = createSlice({
  ...
  extraReducers: (builder) => {
    ...
    builder
      ...
      .addCase(fetchValueReport.fulfilled, (state, { payload }) => { state.loading = false; state.valueReport = payload; })
      .addCase(fetchSpareReport.pending, pendingState)
      .addCase(fetchSpareReport.rejected, rejectedState)
      .addCase(fetchSpareReport.fulfilled, (state, { payload }) => { state.loading = false; state.spareReport = payload; })
      .addCase(fetchDealerReport.pending, pendingState)
      .addCase(fetchDealerReport.rejected, rejectedState)
      .addCase(fetchDealerReport.fulfilled, (state, { payload }) => { state.loading = false; state.dealerReport = payload; })
      .addCase(fetchDailySummary.pending, pendingState)
      .addCase(fetchDailySummary.rejected, rejectedState)
      .addCase(fetchDailySummary.fulfilled, (state, { payload }) => { state.loading = false; state.dailySummary = payload; })
      .addCase(fetchPendingReport.pending, pendingState)
      .addCase(fetchPendingReport.rejected, rejectedState)
      .addCase(fetchPendingReport.fulfilled, (state, { payload }) => { state.loading = false; state.pendingReport = payload; })
      .addCase(fetchDeliveredNRNAReport.pending, pendingState)
      .addCase(fetchDeliveredNRNAReport.rejected, rejectedState)
      .addCase(fetchDeliveredNRNAReport.fulfilled, (state, { payload }) => { state.loading = false; state.deliveredNRNA = payload; });
  },
});
